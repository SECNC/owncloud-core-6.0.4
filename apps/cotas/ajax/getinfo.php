...
if($tipo == 0){
	...
	$tenantaws = getTenantInfos($info['user'][$user]['/$user/files/' . $tenant]['options']['tenant'],$info['user'][$user]['/$user/files/' . $tenant]['options']['password_encrypted'],$info['user'][$user]['/$user/files/' . $tenant]['options']['user'],$info['user'][$user]['/$user/files/' . $tenant]['options']['url'] . '/tokens',$info['user'][$user]['/$user/files/' . $tenant]['options']['bucket']);

//	$tenantaws = getTenantInfos($info['user'][$user][$key[0]]['options']['tenant'],$info['user'][$user][$key[0]]['options']['password_encrypted'],$info['user'][$user][$key[0]]['options']['user'],$info['user'][$user][$key[0]]['options']['url'] . '/tokens',$info['user'][$user][$key[0]]['options']['bucket']);
}
else{
