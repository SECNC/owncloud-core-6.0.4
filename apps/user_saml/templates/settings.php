...
<form id="saml" action="#" method="post">
	...
	<fieldset id="samlSettings-2">
		...
		<p><label for="saml_displayname_mapping"><?php p($l->t('DisplayName2'));?></label><input type="text" id="saml_displayname_mapping_2" name="saml_displayname_mapping_2" value="<?php p($_['saml_displayname_mapping_2']); ?>" /></p>
